...
import { GetMap, useGetMapProvince } from "src/Core/services/public/api-map";
import Map from "../map";

const IranMap = () => {
  // const { data } = GetMap();
  const getMapProvience = useGetMapProvince();

  const map = getMapProvience?.data?.data?.result;
    ...
    <div className="px-[20px] lg:px-[50px] mt-20">
      ...
      <div className="grid lg:grid-cols-2 py-6">
        <div className="mb-4 md:mb-0">
          <Map
            activeMap={getMapProvience?.data?.data?.result}
