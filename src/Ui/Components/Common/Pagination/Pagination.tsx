  ...
  return (
    <nav aria-label="Page navigation example" className="mx-auto">
      <ul
       ...
       my-10 bg-white rounded-lg dark:bg-slate-900 "
      >
        <li>
          <button
            type="button"
          ...
          if (number < maxPageNumberLimit + 1 && number > minPageNumberLimit) {
            return (
              <li
                ...
                onClick={handleClick}
                className={`page-item h-12 border-2 border-r-0 cursor-pointer text-[#1f1f1f]
                   border-[#066E48]  w-12 flex justify-center items-center 
                    dark:!border-[rgb(63,81,77)]   ${
                      currentPage === number ? "active bg-[#184031] text-white " : null
                    } `}
              >
                {number}
              </li>
